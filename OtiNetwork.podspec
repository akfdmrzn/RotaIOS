...
Pod::Spec.new do |s|
    s.name             = 'OtiNetwork'
    s.version          = '0.2.2'
    s.summary          = 'OtiNetworking Manager includes configuration'
    ...
    s.description      = 'This library provides networking process of our projects'
    s.swift_version = '4.0'
    ...
    s.source           = { :git => 'https://github.com/akfdmrzn/OtiNetwork.git', :tag => s.version.to_s }
