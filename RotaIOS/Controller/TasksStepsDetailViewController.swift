...
extension TasksStepsDetailViewController : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        ...
        case self.tableViewTasksStepsDetailPaxes:
            ...
            cell.delegate = self
            cell.setInfo(index: indexPath.row, nameSurname: self.paxesLists[indexPath.row].paxNameSurname ?? "", ageType: self.paxesLists[indexPath.row].paxType ?? "", operatorName: self.paxesLists[indexPath.row].operatorName ?? "", market: self.paxesLists[indexPath.row].marketName ?? "", check: false)
            return cell
        default:
            let cell = tableView.dequeueReusableCell(withIdentifier: TasksStepsDetailTableViewCell.identifier, for: indexPath) as! TasksStepsDetailTableViewCell
