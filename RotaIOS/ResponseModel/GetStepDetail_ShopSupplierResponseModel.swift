...
public class GetStepDetailPaxesList : NSObject {
    ...
    public init(_id : String, ids: String, stepId: String, companyId: String, tourTransferPlanArrAndDepId: String, realAdult: String, realChild: String, realToodle: String, realInfant: String, realTotal: String, paxesLists: [PaxesLists]) {
        self._id = _id
        self.ids = ids
