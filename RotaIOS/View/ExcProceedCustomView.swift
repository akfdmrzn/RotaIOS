    ...
    @IBAction func sendButtonTapped(_ sender: Any) {
        ...
        if self.balanceAmount == 0.0{
            ...
            if self.tourList.count > 0 && self.touristList.count > 0 && self.voucherNo.count > 0{
                ...
                // Refund Contidion
                let russian = "1)Турист обязан предъявить экскурсионный  ваучер (далее – ваучер) гиду до начала экскурсии. Туристы, без ваучера на экскурсию не допускаются.   2) При аннуляции экскурсии не позднее, чем за 24 часа до ее начала – возврат составляет 70% от стоимости  (актуально для всех экскурсий, за исключением индивидуальных, с авиа перелетами, с пересечением границ, полет на воздушном шаре). При аннуляции экскурсии менее чем за 24 часа до ее начала – возврат составляет 50% от стоимости  (актуально для всех экскурсий, за исключением индивидуальных; с авиа перелетами; полет на воздушном шаре;с пересечением границ,  3) При аннуляции экскурсии по болезни, в случае предоставления туристом оригинала справки за подписью врача, возврат составляет 100% от стоимости экскурсии, актуально для всех экскурсий (заключение врача должно быть получено из полноценной больницы/госпиталя в стране отдыха и содержать номер диплома врача, подпись и дату обращения), за исключением индивидуальных, с авиа перелетами,  с пересечением границ, полет на воздушном шаре). 4) При аннуляции экскурсии с виаперелетом,полет на воздушном шаре, частной яхтой (даже по причине болезни и наличии справки от врача), возврат составляет 10% от стоимости. 5) При аннуляции индивидуальной экскурсии или экскурсии с пересечением границ за 24 часа и более до начала (даже по причине болезни и при наличии справки от врача) возврат составляет 50% от стоимости (возрат стоимости не осуществляется, если аннуляция сделана менее, чем за 24 часа до начала экскурсии).   6) Возврат стоимости при аннуляции экскурсии, приобретенной по промо цене / акции,  не осуществляется.   7) Возврат стоимости при аннуляции экскурсии, приобретенной по входные билеты ,  не осуществляется.   8) При аннуляции экскурсии, возврат стоимости входных билетов, приобретенных на имя туриста, не осуществляется (вычитается из общей суммы возврата).   9) В случае аннуляции или замены экскурсии,  ранее выданный ваучер подлежит возврату отельному гиду.   10) Оплаченная экскурсия и выданный ваучер являются подтверждением того, что турист ознакомлен и согласен со всеми требованиями и условиями аннуляции экскурсии.   11) Если гостю отказано в пересечении международной границы, он будет уведомлен о сумме возврата индивидуально.   12) Если гость покупает экскурсию с дополнительными услугами, при отмене тура расчет суммы и % по возврату применяется к полной стоимости приобретенного тура."
                
                let polish = "1)Goście są zobowiązani do przedstawienia przewodnikowi biletu/voucheru na wycieczkę przed rozpoczęciem wycieczki. Uczestnik który nie posiada lub nie przedstawi biletu nie może uczestniczyć w wycieczce.   2) Jeżeli anulacja została złożona na wcześniej niż 24 godziny przed rozpoczęciem wycieczki goście upoważnieni są do zwrotu 70% kosztów ( wyjątek: wycieczki samolotowe, lot balonem, prywatne i indywidualne, oraz wycieczki poza granicę kraju wakacji).Jeżeli anulacja zostanie złożona na mniej niż 24 godziny przed rozpoczęciem wycieczki goście są upoważnieni do 50% zwrotu.   3) W wypadku anulacji wycieczki spowodowanej chorobą uczestnika goście są upoważnieni do zwrotu 100% kosztów wycieczki po okazaniu oryginalnego raportu lekarskiego podpisanego przez lekarza. (Raport lekarski musi zostać wystawiony przez pełnoprawny szpital w miejscu realizacji imprezy turystycznej, musi również zawierać podpis lekarza, jego numer dyplomu oraz termin realizacji wycieczki).Wyjątkiem są wycieczki lotnicze, lot balonem,  prywatne, indywidualne i organizowane poza granicę kraju wakacji.   4) W przypadku anulacji wycieczki lotniczej, lot balonem, wynajmu prywatnego jachtu goście są upoważnieni do zwrotu 10% kosztów wycieczki - również w wypadku choroby, również po okazaniu raportu lekarskiego).   5) W przypadku anulacji wycieczki indywidualnej, prywatnej lub organizowanej poza granicę kraju wakacji, jeżeli złożenie anulacji nastąpi nie mniej niż 24 godziny przed rozpoczęciem goście upoważnieni są do zwrotu 50% kwoty wycieczki. W przypadku anulacji na mniej niż 24 godziny przed rozpoczęciem goście nie są upoważnieni do zwrotu.   6) Nie ma możliwości zwrotu kosztów wycieczki zakupionej po obniżonej cenie.   7) Nie ma możliwości zwrotu kosztów wycieczki zakupionej po bilety wstępu.   8) Jeżeli cena wycieczki obejmuje bilet wstępu do zwiedzanego obiektu, cena biletu zostanie odjęta od wysokości zwrotu.   9) Bilet/voucher na wycieczkę musi zostać zwrócony rezydentowi podczas realizacji zwrotu lub zmiany wycieczki.   10) Zakup wycieczki przez uczestnika jest równoznaczny z zaakceptowaniem wszystkich warunków uczestnictwa.   11) Jeżeli uczestnik nie zostanie wpuszczony na terytorium kraju realizacji wycieczki zwrot zostanie wyliczony indywidualnie a o jego wysokości uczestnik zostanie poinformowany przez organizatora.   12) Jeżeli uczestnik zakupił wycieczkę z dodatkowymi usługami wysokość zwrotu obejmuje zarówno podstawowy koszt wycieczki jak i dodatkowych usług."
                
                let english = "1)The guest has to present the excursion voucher to the excursion guide prior to the start of the excursion. Any guest who does not have or doesn't present an excursion voucher, can not participate in the excursion.   2) 70% of the excursion sale price is refunded to the guest for the cancellations up to 24 hours before the start of all excursions (Except flight,Balloon flight, private(individual) and abroad excursions). Refund will be 50% of the excursion sale price if the cancellation is made less than 24 hours before the start of the excursion.   3) In case of any illness; if the original signed report from the doctor is presented, %100 of the excursion sale price is refunded for all excursions (The doctor’s report must be received from a full-fledged hospital in the holiday destination and must include the doctor’s diploma number, the signature and the relevant tour date) except flight, balloon flight, ballon flight, private and abroad excursions.   4) In case of a cancellation of an excursion with a flight or a private yacht (even due to illness and the presence of a doctor report from a full-fledged hospital in the holiday destination), the refund will be %10 of the excursion sale price.   5) In case of any cancellations up to 24 hours before the start of an private(individual) or an abroad excursion (even due to illness and the presence of a doctor report from a full-fledged hospital in the holiday destination), %50 of excursion sale price is refunded. There will be no refund if the cancellation is made less than 24 hours before the start of the excursion.   6) Refund is not available for the promotional excursions.   7) Refund is not available for the excursions with entrance tickets only.   8) Amount of entrance ticket purchased in the name of the guest is deducted from the total refund amount.   9) The excursion voucher must be returned to the hotel guide in case of any cancellation or change.   10) The purchased excursion ticket indicates that the participant agrees with all the requirements for the service.   11) If the guest is refused at any international border crossing; guest will be notified with the amount of refund from excursion sale price.   12) If the guest buys an excursion with an additional(extra) service, the refund rule is applied over the sum of the excursion price and the additional(extra) service price."
                
                let german = "1)Der Gast hat den Ausflugsgutschein vor Beginn des Ausflugs dem Ausflugsleiter vorzulegen. Jeder Gast, der keinen Ausflugsgutschein hat oder vorlegt, kann nicht am Ausflug teilnehmen.   2) 70 % des Ausflugsverkaufspreises werden dem Gast bei Stornierungen bis 24 Stunden vor Beginn aller Ausflüge (außer Flug, luft balloon, private (individuelle) und Auslandsausflüge) zurückerstattet. Die Rückerstattung beträgt 50% des Ausflugsverkaufspreises, wenn die Stornierung weniger als 24 Stunden vor Beginn des Ausflugs erfolgt.   3) Im Krankheitsfall: bei Vorlage des unterschriebenen Originalberichts eines Arztes werden für alle Ausflüge 100 % des Ausflugsverkaufspreises zurückerstattet (Der Arztbericht muss von einem vollwertigen Krankenhaus am Urlaubsort vorgelegt werden und muss die Arztdiplomnummer, die Unterschrift enthalten und das jeweilige Tour Datum) Dies gilt nicht für Flug-, luft balloon, Privat- und Auslandsausflüge.   4) Im Falle einer Absage eines Ausflugs mit einem Flug, luft balloon oder einer privaten Yacht (auch aufgrund von Krankheit und Vorliegen eines ärztlichen Gutachtens eines vollwertigen Krankenhauses am Urlaubsziel) werden 10 % des Ausflugspreises zurückerstattet.   5) Bei Stornierungen bis 24 Stunden vor Beginn eines privaten (individuellen) oder Auslandsausflugs (auch wegen Krankheit und Vorliegen eines ärztlichen Gutachtens eines vollwertigen Krankenhauses am Urlaubsort), werden 50% des Ausflugsverkaufspreis zurückerstattet. Es erfolgt keine Rückerstattung, wenn die Stornierung weniger als 24 Stunden vor Beginn des Ausflugs erfolgt.   6) Für Werbeausflüge ist keine Rückerstattung möglich.   7) Für nur Eintrittskarten ist keine Rückerstattung möglich.   8) Der Betrag der im Namen eines Gastes gekauften Eintrittskarte wird vom Gesamtrückerstattungsbetrag abgezogen.   9) Der Ausflugsgutschein muss im Falle einer Stornierung oder Änderung an den Hotelführer zurückgegeben werden.   10) Das gekaufte Ausflugsticket zeigt an, dass der Teilnehmer mit allen Anforderungen für die Dienstleistung einverstanden ist.   11) Wenn der Gast an einem internationalen Grenzübergang abgelehnt wird: Der Gast wird über den Erstattungsbetrag vom Ausflugsverkaufspreis benachrichtigt.   12) Kauft der Gast eine Exkursion mit einer zusätzlichen Leistung, wird die Rückerstattungsregel auf die Summe des Ausflugspreises und des zusätzlichen Leistungspreises angewendet."
                
                let ukranian = "1)Турист зобов'язаний пред'явити екскурсійний ваучер (далі – ваучер) до початку екскурсії Туристи без ваучера на екскурсію не допускаються (поширюється на всі екскурсії) 2)При ануляції екскурсії не пізніше, ніж за 24 години до її початку – повернення становить 70% вартості (актуально для всіх екскурсій, за винятком індивідуальних, з авіа перельотами, з перетином кордонів, політ на повітряній кулі)При ануляції екскурсії менш ніж за 24 години до її початку – повернення становить 50% від вартості (актуально для всіх екскурсій, за винятком індивідуальних, з авіаперельотами, з перетином кордонів, політ на повітряній кулі) 3)При ануляції екскурсії через хворобу, у разі надання туристом оригіналу довідки за підписом лікаря повернення становить 100% вартості екскурсії, актуально для всіх екскурсій (висновок лікаря має бути отримано з повноцінної лікарні/госпіталю в країні відпочинку та містити номер диплома лікаря, підпис та дату звернення), за винятком індивідуальних, з авіа перельотами, з перетином кордонів, політ на повітряній кулі) 4)При ануляції екскурсії з авіаперельотом, політ на повітряній, куліприватною яхтою (навіть через хворобу та при наявності довідки від лікаря), повернення становить 10% від вартості 5)При ануляції індивідуальної екскурсії або екскурсії з перетином кордонів за 24 години до початку (навіть через хворобу та за наявності довідки від лікаря) повернення становить 50% від вартості (повернення вартості не здійснюється, якщо ануляція зроблена менше, ніж за 24 години до початку екскурсії) 6)Повернення вартості при ануляції екскурсії придбаної за промо ціною/акцією, не здійснюється 7)При ануляції екскурсії, повернення вартості вхідних квитків, придбаних на ім'я туриста, не здійснюється (віднімається із загальної суми повернення) 8)У разі ануляції або заміни екскурсії, раніше виданий ваучер підлягає поверненню гіду готелю 9)Оплачена екскурсія та виданий ваучер є підтвердженням того, що турист ознайомлений та погоджується з усіма вимогами та умовами ануляції екскурсії 11)Якщо гостю відмовлено у перетині міжнародного кордону, він отримає інформацію про суму повернення індивідуально 12)Якщо гість купує екскурсію з додатковими послугами, при скасуванні туру розрахунок суми та % по поверненню застосовуєтеся до повної"
                
                let lithuanian = "1)Svečias turi atiduoti ekskursijos bilietą gidui, prieš prasidedant ekskursijai. Kiekvienas neturintis ekskursijos bilieto, negalės vykti į kelionę.   2) Atšaukus ekskursiją likus ne mažiau nei 24 valandom iki jos pradžios yra grąžinama 70% nuo pradinės sumos (išskyrus lėktuvines, skrydis oro balionu, individualias ekskursijas). Likus mažiau nei 24 valandom iki ekskursijos pradžios grąžinama 50% nuo pradinės sumos.   3)Susirgus prašoma gydytojo išvados, kad žmogus serga. Tokiu atveju bus grąžinta visa sumokėta suma (gydytojo pažyma turi būti oficialiai pasirašyta gydytojo). oro balionas, Išimtis, individualios ir oro kelionės neįtraukiamos. 4) Atšiaukiant ekskursijas lėktuvu, skrydis oro balionu arba individualia jachta (net jei bus pateikta oficiali gydytojo pažyma), grąžinama 10% nuo pradinės sumos.   5) Atšaukus individualią ekskursiją (netgi turint gydytojo oficialią pažymą) likus ne mažiau nei 24 valandom iki jos pradžios yra grąžinama 50% nuo pradinės sumos. Likus mažiau nei 24 valandom iki ekskursijos pradžios - negrąžinama.   6) Jeigu ekskursija buvo įsigyta pritaikius nuolaidą, ją atšaukiant, pinigų grąžinimas negalimas.   7) Įsigijus tik įėjimo bilietą - pinigų grąžinimas negalimas.   8) Svečio vardu pirkto įėjimo bilieto suma išskaičiuojama iš visos grąžinamos sumos.   9) Kelionės bilietas turi būti paduotas gidui, jei kelionė yra atšaukiama arba taikomi pakeitimai susiję su kelione.   10) Ekskurijos bilietas rodo, jog svečias sutinka su visomis operatoriaus kelionės sąlygomis.   11) Jei svečias yra sustabdomas bet kuriame tarptautiniame sienos kirtimo punkte, bus informuotas apie grąžinamą ekskursijos sumą.   12) Svečiui perkant ekskursiją su papildoma paslauga, pinigų grąžinimas bus taikomas nuo ekskursijos ir papildomos paslaugos sumos."
                
                let latvian = "1)Viesim pirms ekskursijas sākuma ir jāuzrāda ekskursijas gidam ekskursijas biļete. Klients, kuram nav vai nevar uzrādīt ekskursijas biļeti, nevar piedalīties ekskursijā.   2) Ekskursijas atcelšanas gadījumā līdz 24 stundām pirms ekskursijas sākuma, klientam tiek atgriezti 70% no ekskursijas summas. (Izņemot lidojumu, lidojuma balons, privātās (individuālās) un ārzemju ekskursijas.) Ja rezervācija tiek atcelta mazāk kā 24 stundas pirms ekskursijas sākuma, tiek atmaksāti 50% no ekskursijas pārdošanas summas.   3) Jebkuras slimības gadījumā; 100% tiek atmaksāti no ekskursijas pārdošanas summas uzrādot ārsta parakstītu slēdziena oriģinālu (Ārsta izziņa jāsaņem no oficiāli reģistrētas medicīniskās iestādes, un tajā jāiekļauj ārsta diploma numurs, paraksts un attiecīgās ekskursijas datums), izņemot lidojumus, lidojuma balons,  privātas un ārzemju ekskursijas.   4) Izņemot lidojumu, lidojuma balons, privātās (individuālās) un ārzemju ekskursijas. ( kas saistīta ar slimības gadījumu, un ir saņemta izziņa no ārsta, no oficiāli reģistrētas medicīnas iestādes) atmaksa 10 % no ekskursijas pārdošanas summas.   5) Jebkuru atcelšanu līdz 24 stundām pirms ekskursijas sākuma (individuālā) vai ārzemju ekskursijas (kas saistīta ar slimības gadījumi, un ir saņemta izziņa no ārsta, no oficāli reģistrētas medicīniskās iestādes) tiek atmaksāti 50% no ekskursijas pārdošanas summas. Nauda netiek atgriezta, ja atcelšana tiek veikta mazāk kā 24 stundas pirms ekskursijas sākuma.   6) Atmaksa nav iespējama par piedāvātām reklāmas ekskursijām.   7) Atmaksa nav iespējama par ekskursijām ar ieejas biļetēm.   8) Uz klienta vārda iegādātās ieejas biļetes summa tiek atskaitīta no kopējās atmaksas summas.   9) Ekskursijas biļete ir jāatdod viesnīcas gidam jebkuras atcelšanas vai izmaiņu gadījumā.   10) Iegādātā ekskursijas biļete norāda, ka dalībnieks piekrīt visām pakalpojuma sniedzēja prasībām.   11) Ja klientam, jebkurā, starptautiskā robežšķērsošanas vietā tiek uzteikta šķērsošana; viesis tiks informēts par atmaksājamo summu no ekskursijas pārdošanas summas (ārpus esošās valsts izbraucieni vai lidojumi).   12) Ja viesis iegādājas ekskursiju ar papildu pakalpojumu (ar piemaksu), atmaksas noteikums tiek piemērots ekskursijas cenas un papildu pakalpojuma ( piemaksas) cenas summai."
                
                let estonian = "1)Reisija peab esitama ekskursioonivautšeri ekskursiooni giidile enne ekskursiooni algust. Reisija, kellel ei ole ekskursioonivautšerit või kes seda ei esita, ei saa ekskursioonil osaleda.   2) Kuni 24 tundi enne kõigi ekskursioonide algust tagastatakse tühistamise korral reisijale 70% ekskursiooni müügihinnast (v.a. lennu-, lennuõhupall,  individuaal- ja välismaised ekskursioonid). Kui tühistamine toimub vähem kui 24 tundi enne ekskursiooni algust, tagastatakse 50% ekskursiooni müügihinnast.   3) Mistahes haiguse korral ainult ja tingimusel, et reisija esitab selle kohta arsti poolt allkirjastatud originaaltõendi, tagastatakse 100% ekskursiooni müügihinnast kõigi ekskursioonide eest, v.a. lennu, era- ja välismaiste ekskursioonide puhul. Arstitõend peab olema saadud ametikust haiglast ja sisaldama arsti diplomi numbrit, lennuõhupall, allkirja ja asjakohase ekskursiooni kuupäeva).   4) Lennuõhupall, Lendu- või erajahti sisaldava ekskursiooni tühistamise korral (ka haiguse tõttu ja ametlikust haiglast saadud arstitõendi olemasolu korral) tagastatakse 10% ekskursiooni müügihinnast. 5) Juhul, kui ekskursioon tühistatakse kuni 24 tundi enne individuaalse või välismaise ekskursiooni algust (isegi haiguse ja ametliku haigla arstitõendi olemasolu korral), tagastatakse 50% ekskursiooni müügihinnast. Kui tühistamine toimub vähem kui 24 tundi enne ekskursiooni algust, siis raha ei tagastata.   6) Kampaaniaekskursioonide puhul raha ei tagastata.   7) Kui ekskursioon sisaldab sissepääsupileteid, siis piletite maksumuse eest raha ei tagastata.   8) Reisija nimele ostetud sissepääsupileti summa arvatakse maha kogu tagasimakstavast summast.   9) Ekskursioonivautšer tuleb tagastada hotelli giidile mistahes tühistamise või muutmise korral.   10) Ostetud ekskursioonivautšer kinnitab, et osaleja nõustub kõigi teenuse tingimustega.   11) Kui reisijal keelatakse mis tahes rahvusvahelisel piiripunktil riiki sisenemine; teatatakse tagastussumma ekskursiooni müügihinnast iga juhtumi puhul eraldi.   12) Kui külaline ostab ekskursiooni koos lisa – või ekstrateenusega, kohaldatakse eelpoolnimetatud tagasimakse reegleid nii ekskursiooni hinnale kui ka lisa – või ekstrateenuste hinnale."
                ...
                for i in 0...perTourPriceList.count - 1 {
                    ...
                    self.refundCondationLabel = "^FO20,\(bottomListSzieNumberList[i] + 100)^FD\(refundCondition)^FS"
